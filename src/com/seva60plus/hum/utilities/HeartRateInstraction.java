...
public class HeartRateInstraction extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		hasFlash = this.getPackageManager()
                .hasSystemFeature(PackageManager.FEATURE_CAMERA_FLASH);//---Dibyendu
        ...
        backSetup.setOnClickListener(new View.OnClickListener() {
	        ...
	        /*	 isInternetPresent = cd.isConnectingToInternet();
	           ...
	           */ // Take action.
	        	Intent myIntent = new Intent(HeartRateInstraction.this, Registration.class);
		...
		backBtn.setOnClickListener(new View.OnClickListener() {
		 ...
		 banner.setOnClickListener(new View.OnClickListener() {
		        ...
		        public void onClick(View view) {
		            // Take action.
		        /*	Intent myIntent = new Intent(HeartRateInstraction.this, AdBanner.class);
		...
		heartStart.setOnClickListener(new View.OnClickListener() {
	        ...
	        /*
	        	if(hasFlash){
	        		...
	        		Intent myIntent = new Intent(HeartRateInstraction.this, HeartRateMonitor.class);
		        	startActivity(myIntent);
