...
public class MediaCentreArtNCulture extends BaseActivity implements OnClickListener, VideoPlayListListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mContext = MediaCentreArtNCulture.this;
		initView();
	...
	private void initView() {
		...
		tv_fin_advisory.setText("ART & CULTURE");
	...
	private void fetchYoutubePlaylist() {
		...
		if (Util.isInternetAvailable(this)) {
			...
			YoutubePlaylistAsync mAsyncTask = new YoutubePlaylistAsync(mContext, "PLvwCLxrZQZtfiGesLwU2Q20n8aEPIdW3l");
