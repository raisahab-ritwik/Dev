...
public class MediaCentreFitness extends BaseActivity implements OnClickListener, VideoPlayListListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mContext = MediaCentreFitness.this;
		initView();
	...
	private void initView() {
		...
		tv_fin_advisory.setText("FITNESS");
	...
	private void fetchYoutubePlaylist() {
		...
		if (Util.isInternetAvailable(this)) {
			...
			YoutubePlaylistAsync mAsyncTask = new YoutubePlaylistAsync(mContext, "PLvwCLxrZQZtc-Kyx20MzCePvXJm_rEEqj");
