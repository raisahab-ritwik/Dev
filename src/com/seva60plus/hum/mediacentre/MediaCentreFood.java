...
public class MediaCentreFood extends BaseActivity implements OnClickListener, VideoPlayListListener {
	...
	private void fetchYoutubePlaylist() {
		...
		if (Util.isInternetAvailable(this)) {
			...
			YoutubePlaylistAsync mAsyncTask = new YoutubePlaylistAsync(mContext, "PLvwCLxrZQZtdWC_Vea8nYTN1aQLg7sm4T");
