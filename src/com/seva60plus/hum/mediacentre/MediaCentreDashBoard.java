...
public class MediaCentreDashBoard extends Activity{
	
	RelativeLayout option1,option2,option3,option4,option5,option6,option7;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		option1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(MediaCentreDashBoard.this,MediaHumTraning.class);
				startActivity(i);
		...
		option2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent i = new Intent(MediaCentreDashBoard.this,MediaCentreDoctor.class);
				startActivity(i);
		...
		option5.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent i = new Intent(MediaCentreDashBoard.this,MediaCentreInternet.class);
				startActivity(i);
				//Toast.makeText(getApplicationContext(), "Coming Soon!", Toast.LENGTH_SHORT).show();
			}
		});
		...
		option6.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				/*Intent i = new Intent(MediaCentreDashBoard.this,OffersListFinancialActivity.class);
				startActivity(i);*/
				Toast.makeText(getApplicationContext(), "Coming Soon!", Toast.LENGTH_SHORT).show();
			}
		});
		...
		menuIcon.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent intObj = new Intent(MediaCentreDashBoard.this,MenuLay.class);
	        ...
	        /*	 isInternetPresent = cd.isConnectingToInternet();
	                ...
	                if (isInternetPresent) {
	                	...
	                	*/
	    	        	...
	    	        	Intent i = new Intent(MediaCentreDashBoard.this,Registration.class);
	    				startActivity(i);
