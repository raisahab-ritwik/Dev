...
public class MediaCentreDoctor extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//------START------------For Progress Spinner--------------
  		...
  		progress = new Dialog(MediaCentreDoctor.this);
		...
		backSetup.setOnClickListener(new View.OnClickListener() {
	       ...
	       /* 	 isInternetPresent = cd.isConnectingToInternet();
	            ...
	            */        // Internet Connection is Present	
	            // Take action.
	        	Intent i = new Intent(MediaCentreDoctor.this,Registration.class);
	        	startActivity(i);
		...
		menuIcon.setOnClickListener(new View.OnClickListener() {
	        ...
	        public void onClick(View view) {
	            // Take action.
	        	Intent i = new Intent(MediaCentreDoctor.this,MenuLay.class);
	        	startActivity(i);
