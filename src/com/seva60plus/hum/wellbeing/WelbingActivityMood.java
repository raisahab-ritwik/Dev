...
public class WelbingActivityMood extends Activity {
 
	
	String intent_response = null;
    ...
    RelativeLayout bad_btn, okay_btn, good_btn;
    
    Button tab_water_btn, tab_execise_btn, tab_mood_btn;
    Button bad_btn_txt, okay_btn_txt, good_btn_txt;
  ...
  //---------------DB
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*if(intent_response == null){
        	Toast.makeText(getApplicationContext(), "Intent Response NULL", Toast.LENGTH_SHORT).show();
        }
        */
 	...
 	bad_btn.setOnClickListener(new OnClickListener() {
 	...
 	bad_btn_txt.setOnClickListener(new OnClickListener() {
 	...
 	okay_btn.setOnClickListener(new OnClickListener() {
 	...
 	okay_btn_txt.setOnClickListener(new OnClickListener() {
 	...
 	good_btn.setOnClickListener(new OnClickListener() {
 	...
 	good_btn_txt.setOnClickListener(new OnClickListener() {
 	...
 	tab_task.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent intObj = new Intent(WelbingActivityMood.this,WelbingActivityMood.class);
			startActivity(intObj);
			overridePendingTransition(0, 0);
			finish();
		}
 	...
 	tab_sta.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent intObj = new Intent(WelbingActivityMood.this,WelbingStaActivityMood.class);
			startActivity(intObj);
			overridePendingTransition(0, 0);
			finish();
		}
 	...
 	tab_water.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent intObj = new Intent(WelbingActivityMood.this,WelbingActivityWater.class);
			startActivity(intObj);
			overridePendingTransition(0, 0);
			finish();
 	...
 	tab_execise.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent intObj = new Intent(WelbingActivityMood.this,WelbingActivityExercise.class);
			startActivity(intObj);
			overridePendingTransition(0, 0);
			finish();
