...
public class WelbingFragmentThree extends Fragment {
   ...
   public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.welbing_fragment_three, container, false);
	...
	button2=(Button)view.findViewById(R.id.wel_btn2);
	...
	button2.setOnClickListener(new View.OnClickListener() {
      ...
      public void onClick(View view) {
    	  ...
    	  inserData("OKAY", "2", "MODE");
    	  
      	Toast.makeText(getActivity(), "OKAY", Toast.LENGTH_SHORT).show();
      	
      }
  });
	button3=(Button)view.findViewById(R.id.wel_btn3);
