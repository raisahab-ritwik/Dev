...
public class WelbingStaActivityWater extends Activity {
  ...
  //---------------DB
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //------START------------For Progress Spinner--------------
  		...
  		progress = new Dialog(WelbingStaActivityWater.this);
 	...
 	tab_task.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent intObj = new Intent(WelbingStaActivityWater.this,WelbingActivityWater.class);
			startActivity(intObj);
			overridePendingTransition(0, 0);
			finish();
 	...
 	tab_sta.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			// TODO Auto-generated method stub
			Intent intObj = new Intent(WelbingStaActivityWater.this,WelbingStaActivityWater.class);
			startActivity(intObj);
			overridePendingTransition(0, 0);
			finish();
		}
 	...
 	tab_execise.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent intObj = new Intent(WelbingStaActivityWater.this,WelbingStaActivityExercise.class);
			startActivity(intObj);
			overridePendingTransition(0, 0);
			finish();
 	...
 	tab_mood.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent intObj = new Intent(WelbingStaActivityWater.this,WelbingStaActivityMood.class);
			startActivity(intObj);
			overridePendingTransition(0, 0);
			finish();
 	...
 	sync_btn.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent intObj = new Intent(WelbingStaActivityWater.this,Sample.class);
	  ...
	  //-----------Pi Chart----------
	    private void openChart(){    	
	    	...
	    	String[] code = new String[] {
	    			"Less Than 5", "Around 8", "More Than 8","NA" 
	    	};    	
