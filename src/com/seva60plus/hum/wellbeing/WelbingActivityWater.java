...
public class WelbingActivityWater extends Activity {
  ...
  //---------------DB
    ...
    public void onCreate(Bundle savedInstanceState) {
 	...
 	edit_glass = (EditText)findViewById(R.id.edit_glass);
 	
 /*	submit_btn = (RelativeLayout)findViewById(R.id.wel_btn2);
 	submit_btn.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			String glass = edit_glass.getText().toString();
...
more.setOnClickListener(new OnClickListener() {
	...
	public void onClick(View v) {
 	...
 	/*submit_btn_text = (Button)findViewById(R.id.btn_wel_btn2);
 	submit_btn_text.setOnClickListener(new OnClickListener() {
 	...
 	tab_task.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent intObj = new Intent(WelbingActivityWater.this,WelbingActivityWater.class);
			startActivity(intObj);
			overridePendingTransition(0, 0);
			finish();
		}
 	...
 	tab_sta.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent intObj = new Intent(WelbingActivityWater.this,WelbingStaActivityWater.class);
			startActivity(intObj);
			overridePendingTransition(0, 0);
			finish();
		}
 	...
 	tab_execise.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent intObj = new Intent(WelbingActivityWater.this,WelbingActivityExercise.class);
			startActivity(intObj);
			overridePendingTransition(0, 0);
			finish();
 	...
 	tab_mood.setOnClickListener(new OnClickListener() {
		...
		public void onClick(View v) {
			...
			Intent intObj = new Intent(WelbingActivityWater.this,WelbingActivityMood.class);
			startActivity(intObj);
			overridePendingTransition(0, 0);
			finish();
