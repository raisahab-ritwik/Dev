...
public class NearByDashboard extends Activity {
	...
	RelativeLayout atm_btn,hospital_btn,bank_btn,police_btn,airport_btn,
				restaurant_btn,taxi_btn,bus_btn,hotel_btn,cinema_btn,shopping_btn,park_btn,gas_btn;;
...
*/
	    	        	Intent i = new Intent(NearByDashboard.this,Registration.class);
	    				startActivity(i);
	    	...
	    	/*			
	                	...
	                	Intent i = new Intent(Dashboard.this,NoInternetPage.class);
	                	startActivity(i);
	    				overridePendingTransition(0, 0);
		...
		LinearLayout banner=(LinearLayout)findViewById(R.id.footerLay);
		 ...
		 banner.setOnClickListener(new View.OnClickListener() {
		        ...
		        public void onClick(View view) {
		            // Take action.
		        /*	Intent myIntent = new Intent(OffersListElderCareActivity.this, AdBanner.class);
...
//-------------------------------------------------------------------------------
		...
		airport_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intObj.putExtra("myLate", String.valueOf(myLate));
				intObj.putExtra("myLang", String.valueOf(myLang));
				intObj.putExtra("iChoice", "airport");
				startActivity(intObj);
				progress.dismiss();
	...
	/*	bus_btn= (RelativeLayout)findViewById(R.id.bus_btn);
		bus_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intObj.putExtra("myLate", String.valueOf(myLate));
				intObj.putExtra("myLang", String.valueOf(myLang));
				intObj.putExtra("iChoice", "bus_station");
				startActivity(intObj);
				progress.dismiss();
		...
		taxi_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intObj.putExtra("myLate", String.valueOf(myLate));
				intObj.putExtra("myLang", String.valueOf(myLang));
				intObj.putExtra("iChoice", "taxi_stand");
				startActivity(intObj);
				progress.dismiss();
	...
	/*	hotel_btn= (RelativeLayout)findViewById(R.id.hotel_btn2);
		hotel_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intObj.putExtra("myLate", String.valueOf(myLate));
				intObj.putExtra("myLang", String.valueOf(myLang));
				intObj.putExtra("iChoice", "lodging");
				startActivity(intObj);
				progress.dismiss();
		...
		*/
		...
		cinema_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intObj.putExtra("myLate", String.valueOf(myLate));
				intObj.putExtra("myLang", String.valueOf(myLang));
				intObj.putExtra("iChoice", "movie_theater");
				startActivity(intObj);
				progress.dismiss();
	...
	/*	gas_btn= (RelativeLayout)findViewById(R.id.gas_btn);
		gas_btn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				intObj.putExtra("myLate", String.valueOf(myLate));
				intObj.putExtra("myLang", String.valueOf(myLang));
				intObj.putExtra("iChoice", "gas_station");
				startActivity(intObj);
				progress.dismiss();
