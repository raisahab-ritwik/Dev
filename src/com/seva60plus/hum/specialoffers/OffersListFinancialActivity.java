...
public class OffersListFinancialActivity extends Activity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.offers_financial);
		...
		lm = (LocationManager) getSystemService(LOCATION_SERVICE);// by Dibyendu
		 ...
		 banner.setOnClickListener(new View.OnClickListener() {
		        ...
		        public void onClick(View view) {
		            // Take action.
		        /*	Intent myIntent = new Intent(OffersListFinancialActivity.this, AdBanner.class);
		...
		menuIcon.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent intObj = new Intent(OffersListFinancialActivity.this,MenuLay.class);
	        ...
	        /*	 isInternetPresent = cd.isConnectingToInternet();
	                ...
	                if (isInternetPresent) {
	                	...
	                	*/
	    	        	...
	    	        	Intent i = new Intent(OffersListFinancialActivity.this,Registration.class);
	    				startActivity(i);
		...
		visitWebBtn2 = (Button)findViewById(R.id.visit_btn2);
