	...
	public Cursor fetchPillRowId(String hourIs) throws SQLException {
		...
		Cursor mCursor = mDb.query(
				true, DATABASE_TABLE, new String[] {
						KEY_ROWID,
						KEY_HOUR, 
				}, KEY_HOUR + "=" + hourIs, null, null, null, null, null);
		if (mCursor != null) {
			mCursor.moveToFirst();
		}
		return mCursor;
...
//---All Pill from day and time// 15.09.15	
	...
	public Cursor fetchPillAlert(String dayIs) throws SQLException {
		...
		Cursor mCursor = mDb.query(
				true, DATABASE_TABLE, new String[] {
						...
						KEY_HOUR,
						KEY_PILL,
				}, KEY_DAYS + "=" + dayIs, null, null, null, null, null);
		if (mCursor != null) {
			mCursor.moveToFirst();
		}
		return mCursor;
	...
	public Cursor fetchAllReminders() {
		...
		return mDb.query(RDATABASE_TABLE, new String[] {RKEY_ROWID, RKEY_TITLE,
	...
	public Cursor fetchReminder(long rowId) throws SQLException {
		...
		Cursor mCursor =
				...
				mDb.query(true, RDATABASE_TABLE, new String[] {RKEY_ROWID,
