...
check7.setOnClickListener(new OnClickListener() {
	...
	public void onClick(View v) {
		...
		backSetup.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				 ...
				 */ // Take action.
				Intent i = new Intent(PillEdit.this,Registration.class);
				startActivity(i);
	 ...
	 * @param c Entero a a�adir digito
	...
	private void displayListView() {
		...
		dataAdapter = new MyCustomAdapter(this,
				R.layout.pill_list_day, dayList);
		...
		/*   
              ...
              totalHeight = totalHeight + (listView.getDividerHeight() * (dataAdapter.getCount() - 1)+30);
