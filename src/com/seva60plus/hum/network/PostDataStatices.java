...
import com.seva60plus.hum.wellbeing.WelbingActivityMood;
...
public class PostDataStatices extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		if (SOMEACTION.equals(action)) {
			...
			//MainActivity1 ob = new MainActivity1();
			//ob.sendSms();
			Time time = new Time(); 
			time.setToNow();
			...
			if(tm.contains("11101")){
				...
				showNotificationWater(context, R.drawable.icon, "short", false);
			}
			else{
	...
	private void showNotificationExr(Context context, int statusBarIconID, String string, boolean showIconOnly) {
       ...
       // n.sound = Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://com.seva60plus.seva60plus/raw/ex_sound");
	...
	private void showNotificationMood(Context context, int statusBarIconID, String string, boolean showIconOnly) {
        // This is who should be launched if the user selects our notification.
        Intent contentIntent = new Intent(context, WelbingActivityMood.class);
        ...
        //n.sound = Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://com.seva60plus.seva60plus/raw/mood_sound");
		n.defaults |= Notification.DEFAULT_LIGHTS ;
		n.flags |=Notification.FLAG_AUTO_CANCEL;
		n.flags |=Notification.FLAG_INSISTENT;
	...
	private void showNotificationWater(Context context, int statusBarIconID, String string, boolean showIconOnly) {
        // This is who should be launched if the user selects our notification.
        Intent contentIntent = new Intent(context, WelbingActivityWater.class);
        ...
        //n.sound = Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://com.seva60plus.seva60plus/raw/water_sound");
		n.defaults |= Notification.DEFAULT_LIGHTS ;
		n.flags |=Notification.FLAG_AUTO_CANCEL;
		n.flags |=Notification.FLAG_INSISTENT;
