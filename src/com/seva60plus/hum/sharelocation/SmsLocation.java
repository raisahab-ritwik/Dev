...
public class SmsLocation extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// LocationMsg = Lat + Lng;
		/*
		 * url = (SpannableString) Html.fromHtml(
		 * "<b>Find Your Frinend Location:... </b>  Please " + " " +
		 * "<a href=\"http://www.google.co.in/maps/@" + Lat + "," + Lng +
		 * ",15z?hl=en\"><u>Click Here..</u></a> " );
		 */
		//-------------Create Url----- 
		// msgUrl = url + Lat + "," + Lng + ",?hl=en" ;

		msgUrl = "https://www.google.co.in/maps/place/" + Lat + "," + Lng;
		/*
		 * SpannableString str = SpannableString.valueOf("click");
		 * str.setSpan(new URLSpan(msgUrl),
		 * 0,entryValue.length(),Spannable.SPAN_INCLUSIVE_EXCLUSIVE);
		 */
		//System.out.println("url: "+LocationMsg);
		// msgUrl = "Ok";
		...
		backBtn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				// Take action.
				Intent i = new Intent(SmsLocation.this, Registration.class);
				startActivity(i);
				overridePendingTransition(0, 0);
				finish();
				/*
				 * } else { // Internet connection is not present Intent i = new
				 * Intent(SmsLocation.this,NoInternetPage.class);
